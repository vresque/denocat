...
#define  VS_PLATFORM_IOS
#error "IOS is not supported!"
#elif TARGET_OS_MAC == 1
#define  VS_PLATFORM_MACOS
...
#define  VS_PLATFORM_ANDROID
#error "Android is not supported!"
#elif defined(__linux__)
#define  VS_PLATFORM_LINUX
...
#endif
#else
#error Denocat only supports Windows!
