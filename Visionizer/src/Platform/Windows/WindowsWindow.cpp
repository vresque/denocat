...
namespace Visionizer
{
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		GLFWwindow* before = m_Window;
		GLFWwindow* glfwWindow = (GLFWwindow*)glfwCreateWindow((int)props.Width, (int)props.Height, m_Data.Title.c_str(), nullptr, nullptr);
		GLFWwindow* after = glfwWindow;
		m_Window = glfwWindow;

		m_Context = new OpenGLContext((GLFWwindow*)m_Window);
		m_Context->Init();
